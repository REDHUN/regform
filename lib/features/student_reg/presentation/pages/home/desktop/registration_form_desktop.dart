...
class RegDesktop extends StatefulWidget {
  const RegDesktop({super.key});

  @override
  State<RegDesktop> createState() => _RegistrationPageState();
}

class _RegistrationPageState extends State<RegDesktop> {
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      width:
                                          MediaQuery.of(context).size.width / 2,
                                      child: FutureBuilder<List<AllClass>>(
                                        future: DropDownButtonBuilder
                                            .getClassCourse(
